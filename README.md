...
1. **Clone the Repo:**
   ```bash
   git clone [https://github.com/YOUR_USERNAME/SSC-Scholar-Trader-Bot.git](https://github.com/YOUR_USERNAME/SSC-Scholar-Trader-Bot.git)
   cd SSC-Scholar-Trader-Bot
